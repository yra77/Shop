...
{
    internal class RangeSlider : View
    {
        ...
        public static readonly BindableProperty TextColorProperty =
            BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(RangeSlider), Color.Parse("#000000"));
        ...
        public static readonly BindableProperty ActiveColorProperty =
            BindableProperty.Create(nameof(ActiveColor), typeof(Color), typeof(RangeSlider), Color.Parse("#000000"));

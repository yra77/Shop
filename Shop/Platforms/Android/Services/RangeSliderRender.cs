...
using Shop.Enums;
using Shop.Controls;
using Shop.Platforms.Android.Helpers;
...
[assembly: ExportRenderer(typeof(RangeSlider), typeof(RangeSliderRender))]

namespace Shop.Platforms.Android.Services
{
    internal class RangeSliderRender : ImageView
    {
        public static readonly android.Color DefaultDarkBlueColor = android.Color.Argb(255, 51, 181, 229);
        public static readonly android.Color DefaultLightBlueColor = android.Color.ParseColor("#4297F4");//Argb(154, 51, 181, 229);
        public static readonly android.Color DefaultGrayColor = android.Color.ParseColor("#C8C8C8");//Argb(77, 136, 136, 136);
        public static readonly android.Color DefaultLightestBlueColor = android.Color.Argb(102, 51, 181, 229);
        ...
        private readonly android.Paint _paint = new android.Paint(PaintFlags.FakeBoldText);// AntiAlias);
        private readonly android.Paint _shadowPaint = new android.Paint();
        private readonly Matrix _thumbShadowMatrix = new Matrix();
        private readonly android.Path _translatedThumbShadowPath = new android.Path();
        ...
        private android.Color _activeColor;
        ...
        protected RangeSliderRender(IntPtr javaReference, JniHandleOwnership transfer) : base(javaReference, transfer)
        {
        }

        public RangeSliderRender(Context context) : base(context)
        {
            Init(context, null);
        }

        public RangeSliderRender(Context context, IAttributeSet attrs) : base(context, attrs)
        {
            Init(context, attrs);
        }

        public RangeSliderRender(Context context, IAttributeSet attrs, int defStyleAttr)
            : base(context, attrs, defStyleAttr)
        {
            Init(context, attrs);
        }

        public RangeSliderRender(Context context, IAttributeSet attrs, int defStyleAttr, int defStyleRes)
        ...
        public android.Color ActiveColor
        {
        ...
        public android.Color DefaultColor { get; set; }
        ...
        public android.Color TextAboveThumbsColor { get; set; }

        private android.Color thumbShadowColor { get; set; }
        ...
        private static android.Drawables.ShapeDrawable Circle(android.Color color)
        {
            var circle = new android.Drawables.ShapeDrawable(new android.Drawables.Shapes.OvalShape());
        ...
        {
            var defaultShadowColor = android.Color.Argb(75, 0, 0, 0);
            ...
            if (attrs == null)
            {
                ...
                DefaultColor = android.Color.ParseColor("#C8C8C8");// Gray;
                AlwaysActive = false;
                ShowTextAboveThumbs = true;
                TextAboveThumbsColor = android.Color.White;
            ...
            else
            {
                ...
                try
                {
                    ...
                    TextAboveThumbsColor = a.GetColor(Resource.Styleable.RangeSliderControl_textAboveThumbsColor, android.Color.White);
                    ...
                    DefaultColor = a.GetColor(Resource.Styleable.RangeSliderControl_defaultColor, android.Color.Gray);
        ...
        private Drawable GetMaterialUiThumbDrawable(android.Color color)
        {
        ...
        private Drawable GetThumbDrawable()
        {
            ...
            else
            {
                ...
                var innerCircle = Circle(android.Color.White);// DefaultDarkBlueColor);
        ...
        private Drawable GetPressedThumbDrawable()
        {
            ...
            else
            {
                ...
                outerCircle.Paint.SetStyle(android.Paint.Style.Fill);// Stroke);
        ...
        private Drawable GetDisabledThumbDrawable()
        {
            ...
            {
                var outerCircle = Circle(DefaultLightBlueColor);//внешний круг
                var innerCircle = Circle(android.Color.White);//внутренний круг
        ...
        public void SetTextAboveThumbsColor(android.Color textAboveThumbsColor)
        {
        ...
        {
            SetTextAboveThumbsColor(new android.Color(Resources.GetColor(resId, null)));
        }
        ...
        protected override void OnMeasure(int widthMeasureSpec, int heightMeasureSpec)
        {
            ...
            var height = ThumbImage.Height
                         + (ShowTextAboveThumbs ? PixelUtil.DpToPx(Context, HeightInDp)
                         + PixelUtil.SpToPx(Context, TextSizeInSp) : 0)
        ...
        protected override void OnDraw(Canvas canvas)
        {
            ...
            _paint.SetStyle(android.Paint.Style.Fill);

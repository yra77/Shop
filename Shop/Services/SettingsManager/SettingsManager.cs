...
namespace Shop.Services.SettingsManager
{
    class SettingsManager : ISettingsManager
    {
        ...
        {
            get => Preferences.Get(nameof(IsCircleCart), false);
            set => Preferences.Set(nameof(IsCircleCart), value);
        }

        public bool IsCircleFavorit
        {
            get => Preferences.Get(nameof(IsCircleFavorit), false);
            set => Preferences.Set(nameof(IsCircleFavorit), value);
        }
